...
1. As this article points out, it's crowded, cluttered, disorganized, and, increasingly, hard to get on - "busy signals for minutes to hours are the norm" - and slow to use. The first class action suit was recently filed against AmericaOnline, seeking to stop their sale of new memberships on the grounds that they cannot provide services as promised to the members they've got. AOL's problems are a microcosm of the entire World Wide Web.

2. The huge numbers of on-line users is, for most marketers, an irrelevant although seductive illusion. Most "business users" are using this thing one way and one way only for e-mail...as a a communication tool, like the phone or the FAX. They aren't "surfing." Or buying. In homes, the primary users are kids under the age of 18.
...
NEAR-ZERO COST CONTINUOUS COMMUNICATION
...
NEAR-ZERO COST PUBLICITY...PROMOTION TO THE MEDIA
