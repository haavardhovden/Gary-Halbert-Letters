...
#3	I have decided to allow subscribers to attend free of charge.
...
P.S.	We regret that we have only three plaques at this special price, so we must accept orders on a first come first served basis. But remember, if you are not completely satisfied for any reason, you may return your order for a full refund or credit. Please see the order card for details.
...
P.S.	I also hope it's ok that I can't think of a snappy title for myself this month.
P.P.S.	But don't worry. I'll come roaring back next month. I promise. By the way, I didn't let Paulette proofread this letter either so it probably contains a jillion typos.
